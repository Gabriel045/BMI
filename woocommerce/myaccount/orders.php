...
<script>
	const status = document.querySelectorAll(".woocommerce-orders-table__cell-order-status")
	status.forEach(element => {
		if (element.textContent.includes("Processing")) {
		...
		} else if (element.textContent.includes("Cancelled")) {
