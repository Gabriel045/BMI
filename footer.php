            ...
            <div class="flex flex-wrap lg:flex-nowrap">
                ...
                <div class="w-full lg:w-[70%] xl:w-[60%] flex flex-wrap lg:flex-nowrap ">
                    <div class="w-full lg:w-1/3 mt-[50px] lg:mt-0 flex flex-col gap-y-[16px]">
                        <span class="text-[16px] text-center lg:text-start  text-[#475467] font-[600]">Have a Question? <br>Email us anytime <br> <a target="_blank" href="mailto:hellow@bmimd.com">orders@bmiMD.com</a></span>
                        <span class="text-[16px] text-center lg:text-start font-[600] text-[#475467]">More questions? <br>Visit our <a href="/faq" class="cursor-pointer">FAQ Page</a></span>
                    </div>
                    <div class="w-full lg:w-1/3 mt-[50px] lg:mt-0 flex flex-col gap-y-[16px]">
                        ...
                        <a href="/how-it-works/" class="text-[16px] text-center lg:text-start cursor-pointer font-[600] text-[#475467]">How it works?</a>
                        <a href="/faq" class="text-[16px] text-center lg:text-start cursor-pointer font-[600] text-[#475467]">FAQ</a>
                    ...
                    <div class="w-full lg:w-1/3 mt-[50px] lg:mt-0 flex flex-col gap-y-[16px]">
                        ...
                        <a href="/terms-of-use/"  class="text-[16px] text-center lg:text-start cursor-pointer text-[#475467] font-[600]">Terms of use</a>
                        <a href="/privacy-policy/" class="text-[16px] text-center lg:text-start cursor-pointer text-[#475467] font-[600]">Privacy</a>
