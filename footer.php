    ...
    <section>
        <div class="block_content px-[30px] lg:px-[112px] pt-[100px] pb-[24px]">
            <div class="flex flex-wrap lg:flex-nowrap">
                ...
                <div class="w-full lg:w-[70%] xl:w-[60%] flex flex-wrap lg:flex-nowrap ">
                    ...
                    <div class="w-full lg:w-1/3 mt-[50px] lg:mt-0 flex flex-col gap-y-[16px]">
                        ...
                        <span class="text-[16px] text-center lg:text-start  font-[600] text-dark-blue">Monday-Thursday
                            a10am-5pm</span>
            ...
            <div>
                ...
                <span class="mt-[32px] text-[16px] text-[#667085] flex justify-center">© 2023 bmiMD | All Rights Reserved</span>
            </div>
        </div>
    </section>
</footer>
